...
/**
 */
class Game_Battle_mod extends MY_Model {
    public function __construct(){
        parent::__construct();
        $this->_table = $this->db->dbprefix.'st_battle_server';
        $this->_id = 'id';
    }

    public function getBattleServers($conditions,$limit=null,&$item_count){
        $res = array();
    ...
    public function ajaxCheckHostId($host_id,$id = ''){
        ...
        $host_id && $condition .= " AND battle_server_host_id = {$host_id} ";
