...
/**
 * 
 * 重定义Email里面的 subject方法
 * 
 * 
 * @package	zwidc@qq.com
 * @author		zhangwei
 * @copyright	Copyright (c) 2012 - 2012, EllisLab, Inc.
 * @license	http://www.zuibang.net
 * @link		http://www.zuibang.net
 * @since		Version 1.0
 * 
 */
...
class MY_Pagination extends CI_Pagination{
	...
	protected function url($url,$page){
		return str_replace('[p]', $page?$page:1, $url);
	}
