<?php require("header.html") ?>
    ...
    <div id="rightTop">
        <p>Battle_server服务列表</p>
        <ul class="subnav">
            <li>
                <a href="index.php?app=game&act=createBattleSet" class="btnS">添加Battle_server服务</a>
            </li>
        </ul>
    </div>
        ...
        <div class="fontl">
            ...
            <form method="GET" id="form">
                <div class="left line-h">
                    ...
                    <input type="hidden" name="act" value="battleSetList" />
                 ...
                 <?php echo $lang['belong_server']?>：
                    ...
                    &nbsp;&nbsp;
                    <input type="button" onclick="window.location='/index.php?app=game&act=battleSetList'" id="goBack"
    ...
    <div class="tdare">
        <table width="100%" cellspacing="0" class="dataTable">
            ...
            <tr class="tatr1">
                ...
                <td width="9%">Battle_Server服务器ID</td>
...
<!--                        <td>--><?php //echo str_cut($val['content'], 58 ); ?><!--</td>-->
                        <td><?php echo $val['battle_server_host_id']; ?></td>
...
<!--                        <td>--><?php //echo $val['in_ip']; ?><!--</td>-->
                        ...
                        <td >
                            ...
                            <a href="index.php?app=game&act=editBattleSet&id=<?php echo $val['id'] ?>">编辑</a>
                            &nbsp;|&nbsp;
