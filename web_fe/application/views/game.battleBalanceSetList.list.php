<?php require("header.html") ?>
    ...
    <div id="rightTop">
        <p>battle_balance负载列表</p>
        <ul class="subnav">
            <li>
                <a href="index.php?app=game&act=createBattleBalanceSet" class="btnS">添加battle_balance负载</a>
            </li>
        </ul>
    </div>
    ...
    <div class="tdare">
        <table width="100%" cellspacing="0" class="dataTable">
            ...
            <tr class="tatr1">
                ...
                <td width="9%">battle_balance负载ID</td>
                <td width="6%">物理主机ID</td>
                <td width="6%">主机local_IP</td>
                <td width="6%">主机wan_IP</td>
                <td width="6%">开服时间</td>
                <td width="10%">battle_for_master_ip</td>
                <td width="10%">battle_for_mater_port</td>
                <td width="10%">battle_for_balance_ip</td>
                <td width="11%">battle_for_balance_port</td>
...
<!--                        <td>--><?php //echo str_cut($val['content'], 58 ); ?><!--</td>-->
                        <td><?php echo $val['battle_balance_host_id']; ?></td>
                        <td><?php echo $val['server_id']; ?></td>
                        <td><?php echo $val['in_ip']; ?></td>
                        <td><?php echo $val['out_ip']; ?></td>
                        <td><?php echo $val['open_server_time']; ?></td>
                        <td><?php echo $val['battle_for_battle_master_ip'] ;?></td>
                        <td><?php echo $val['battle_for_battle_mater_port'] ;?></td>
                        <td><?php echo $val['battle_for_battle_balance_ip'] ;?></td>
                        <td><?php echo $val['battle_for_battle_balance_port'] ;?></td>
                        <td><?php echo $val['zk_path'] ;?></td>
                        <td><?php echo $val['status'] ;?></td>
                        <td >
                            <!--            <a href="javascript:;" onclick="toggle_state('--><?php //echo $val['id'];?><!--',this)"><?php echo $lang['hide']?></a>-->
                            <a href="index.php?app=game&act=editBattleBalanceSet&id=<?php echo $val['id'] ?>">编辑</a>
                            &nbsp;|&nbsp;
