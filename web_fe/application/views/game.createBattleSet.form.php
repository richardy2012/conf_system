<?php require("header.html") ?>
    ...
    <div id="rightTop">
        <ul class="subnav">
            <li><a class="btnS"
           href="index.php?app=game&act=battleSetList">Battle_server服务列表</a></li>
        </ul>
        <p>添加Battle_server服务</p>
    </div>
    ...
    <div class="info" style="height: auto">
        <form method="POST" enctype="multipart/form-data" id="form">
            <table class="infoTable" style="height: auto">
                ...
                <tr rel_data="TOP">
                    <th  class="paddingT15"> BattleServer服务编号:</th>
                    <td class="paddingT15 wordSpacing5">
                        <input class="http" id="battle_server_host_id"
                               type="text"name="battle_server_host_id"
                               value="<?php echo isset($battle_server_host_id) ? $battle_server_host_id : '';?>" />
                        <label class="field_notice">填入Battle服务器的编号</label>
                    </td>
                </tr>
                ...
                <tr rel_data="TOP" style="height: auto">
                    <th class="paddingT15">battle.ini预览</th>
    ...
    <script type="text/javascript">
        //<!CDATA[
        var type = 'battle';
        var l_id = '<?php echo isset($battle_server_host_id) ? $battle_server_host_id : 0;?>';
...
//            }
            ...
            var battle_server_host_id = l_id;


            if(battle_server_host_id.length != 0){
                init_show_set_url = init_show_set_url + '&battle_server_host_id=' +battle_server_host_id;
            }
...
//            }
            ...
            $("tr[rel='equip'] input").blur(function(){
                var battle_server_host_id = $("#battle_server_host_id").val()
...
//                var im_server_host_id_support =$("#im_server_host_id_support").val()
                ...
                if(battle_server_host_id.length != 0){
                    urlSet= urlSet+ '&battle_server_host_id=' +battle_server_host_id;
                }
            ...
            rules:{
                'battle_server_host_id':{
                    ...
                    remote: {
                        ...
                        data:{
                            host_id:function(){
                                return $("#battle_server_host_id").val();
                            },
