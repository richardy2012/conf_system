<?php require("header.html") ?>
    ...
    <div id="rightTop">
        <ul class="subnav">
            <li><a class="btnS"
           href="index.php?app=game&act=BattleStrongholdSetList">Battle_Stronghold服务列表</a></li>
        </ul>
        <p>添加Battle_Stronghold服务</p>
    </div>
    ...
    <div class="info" style="height: auto">
        <form method="POST" enctype="multipart/form-data" id="form">
            <table class="infoTable" style="height: auto">
                ...
                <tr rel_data="TOP">
                    <th  class="paddingT15"> BattleStonghold服务编号:</th>
                    <td class="paddingT15 wordSpacing5">
                        <input class="http" id="battle_stronghold_host_id"
                               type="text"name="battle_stronghold_host_id"
                               value="<?php echo isset($battle_stronghold_host_id) ? $battle_stronghold_host_id : '';?>" />
                        <label class="field_notice">填入BattleStonghold服务的编号</label>
                    </td>
                </tr>
                ...
                <tr rel="equip" >
                    <th class="paddingT15">对外battle_server服务：</th>
                    <td class="paddingT15 wordSpacing5 iparent">
                        <b>ip:</b>
                        <input type="text" id="battle_server_ip" name="battle_server_ip" class="reward_item" />
                        &nbsp;
                        <b>port:</b>&nbsp;
                        <input type="text" id="battle_server_port" name="battle_server_port" class="reward_quantity"/>
                        <label class="field_notice">请输入对外提供battle_server服务的IP和端口</label>
                    </td>
                </tr>
                ...
                <tr rel_data="TOP" style="height: auto">
                    <th class="paddingT15">battle_stronghold.ini预览</th>
                    <td class="paddingT15 wordSpacing5" style="height: 650px">
                        <iframe id="framer" name="framer" src="index.php?app=game&act=showGameSet&set_type=battle" width="100%" height="100%" style="overflow:hidden; border:0;" scrolling="no" frameborder="no" scroll="no">
                        </iframe>
                    </td>
                </tr>
    ...
    <script type="text/javascript">
        //<!CDATA[
        var type = 'battle_stronghold';
        var l_id = '<?php echo isset($battle_stronghold_host_id) ? $battle_stronghold_host_id : 0;?>';
...
//            }
            ...
            var battle_server_ip = "<?php echo isset($battle_server_ip) ? $battle_server_ip : '';?>";
            if(battle_server_ip){
                $("#battle_server_ip").val(battle_server_ip);
            }else{
                $("#battle_server_ip").val('0.0.0.0');
            }

            var battle_server_port = "<?php echo isset($battle_server_port) ? $battle_server_port : '';?>";
            if(battle_server_port){
                $("#battle_server_port").val(battle_server_port);
            }else{
                $("#battle_server_port").val('');
            }

            var init_show_set_url = '';
            var battle_stronghold_host_id = l_id;


            if(battle_stronghold_host_id.length != 0){
                init_show_set_url = init_show_set_url + '&battle_stronghold_host_id=' +battle_stronghold_host_id;
            }
            ...
            if(battle_server_ip.length != 0){
                init_show_set_url = init_show_set_url + '&battle_server_ip=' +battle_server_ip;
            }

            if(battle_server_port.length != 0){
                init_show_set_url = init_show_set_url + '&battle_server_port=' +battle_server_port;
            }
...
//            }
            ...
            $("tr[rel='equip'] input").blur(function(){
                var battle_stronghold_host_id = $("#battle_stronghold_host_id").val()
                var battle_server_ip = $("#battle_server_ip").val()
                var battle_server_port = $("#battle_server_port").val()
...
//                var im_server_host_id_support =$("#im_server_host_id_support").val()
                ...
                if(battle_server_ip.length != 0){
                    urlSet = urlSet + '&battle_server_ip=' +battle_server_ip;
                }

                if(battle_server_port.length != 0){
                    urlSet = urlSet + '&battle_server_port=' +battle_server_port;
                }

                if(battle_stronghold_host_id.length != 0){
                    urlSet= urlSet+ '&battle_stronghold_host_id=' +battle_stronghold_host_id;
                }
            ...
            rules:{
                'battle_stronghold_host_id':{
                    ...
                    remote: {
                        ...
                        data:{
                            host_id:function(){
                                return $("#battle_stronghold_host_id").val();
                            },
