<?php require("header.html") ?>
    ...
    <div id="rightTop">
        <p>load_balance负载列表</p>
        <ul class="subnav">
            <li>
                <a href="index.php?app=game&act=createLoadBalanceSet" class="btnS">添加load_balance负载</a>
            </li>
        </ul>
    </div>
            ...
            <form method="GET" id="form">
                <div class="left line-h">
                 ...
                 <?php echo $lang['belong_server']?>：
                    ...
                    &nbsp;&nbsp;
                    <input type="button" onclick="window.location='/index.php?app=game&act=loadBalanceSetList'" id="goBack"
    ...
    <div class="tdare">
        <table width="100%" cellspacing="0" class="dataTable">
            ...
            <tr class="tatr1">
                ...
                <td width="8%">load_balance负载ID</td>
                <td width="7%">物理主机ID</td>
                <td width="7%">主机local_IP</td>
                <td width="7%">主机wan_IP</td>
                <td width="7%">开服时间</td>
                <td width="9%">load_login_server_ip</td>
                <td width="9%">load_login_server_port</td>
                <td width="9%">load_login_balance_ip</td>
                <td width="10%">load_login_balance_port</td>
                <td width="10%">zk_path</td>
                <td width="6%">状态</td>
...
<!--                        <td>--><?php //echo str_cut($val['content'], 58 ); ?><!--</td>-->
                        <td><?php echo $val['load_balance_host_id']; ?></td>
                        <td><?php echo $val['server_id']; ?></td>
                        <td><?php echo $val['in_ip']; ?></td>
                        <td><?php echo $val['out_ip']; ?></td>
                        <td><?php echo $val['open_server_time']; ?></td>
                        <td><?php echo $val['load_for_login_server_ip'] ;?></td>
                        <td><?php echo $val['load_for_login_server_port'] ;?></td>
                        <td><?php echo $val['load_for_load_balance_ip'] ;?></td>
                        <td><?php echo $val['load_for_load_balance_port'] ;?></td>
                        <td><?php echo $val['zk_path'] ;?></td>
                        <td><?php echo $val['status'] ;?></td>
                        <td >
                            <!--            <a href="javascript:;" onclick="toggle_state('--><?php //echo $val['id'];?><!--',this)"><?php echo $lang['hide']?></a>-->
                            <a href="index.php?app=game&act=editLoadBalanceSet&id=<?php echo $val['id'] ?>">编辑</a>
                            &nbsp;|&nbsp;
