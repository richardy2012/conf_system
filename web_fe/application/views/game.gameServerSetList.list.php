<?php require("header.html") ?>
    ...
    <div id="rightTop">
        ...
        <ul class="subnav">
            <li>
                <a href="index.php?app=game&act=createGameServerSet" class="btnS">添加Game_server服务</a>
            </li>
        </ul>
    </div>
        ...
        <div class="fontl">
            ...
            <form method="GET" id="form">
                <div class="left line-h">
                    ...
                    <input type="hidden" name="act" value="gameServerSetList" />
                 ...
                 <?php echo $lang['belong_server']?>：
                    ...
                    &nbsp;&nbsp;
                    <input type="button" onclick="window.location='/index.php?app=game&act=gameServerSetList'" id="goBack"
    ...
    <div class="tdare">
        <table width="100%" cellspacing="0" class="dataTable">
            ...
            <tr class="tatr1">
                ...
                <td width="9%">Game_Server服务器ID</td>
                <td width="6%">物理主机ID</td>
                <td width="6%">主机wan_IP</td>
<!--                <td width="6%">主机local_IP</td>-->
                <td width="6%">开服时间</td>

                <td width="6%">IM支撑负载ID</td>
                <td width="6%">LB支撑负载ID</td>
                <td width="6%">BB支撑负载ID</td>

                <td width="6%">game_server_ip</td>
                <td width="7%">game_server_port</td>
                <td width="8%">game_server_newwork</td>
...
<!--                        <td>--><?php //echo str_cut($val['content'], 58 ); ?><!--</td>-->
                        <td><?php echo $val['game_server_host_id']; ?></td>
                        <td><?php echo $val['server_id']; ?></td>
                        <td><?php echo $val['out_ip']; ?></td>
<!--                        <td>--><?php //echo $val['in_ip']; ?><!--</td>-->
                        <td><?php echo $val['open_server_time']; ?></td>

                        <td><?php echo $val['im_server_host_id_support']; ?></td>
                        <td><?php echo $val['load_balance_host_id_support']; ?></td>
                        <td><?php echo $val['battle_balance_host_id_support']; ?></td>

                        <td><?php echo $val['game_server_ip'] ;?></td>
                        <td><?php echo $val['game_server_port'] ;?></td>
                        <td><?php echo $val['game_server_network'] ;?></td>
                        <td><?php echo $val['zk_path'] ;?></td>
                        <td><?php echo $val['status'] ;?></td>
                        <td >
                            <!--            <a href="javascript:;" onclick="toggle_state('--><?php //echo $val['id'];?><!--',this)"><?php echo $lang['hide']?></a>-->
                            <a href="index.php?app=game&act=editGameServerSet&id=<?php echo $val['id'] ?>">编辑</a>
                            &nbsp;|&nbsp;
