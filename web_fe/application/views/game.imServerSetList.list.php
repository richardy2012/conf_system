<?php require("header.html") ?>
    ...
    <div id="rightTop">
        ...
        <ul class="subnav">
            <li>
                <a href="index.php?app=game&act=createImServerSet" class="btnS">添加IM_server负载</a>
            </li>
        </ul>
    </div>
    ...
    <div class="tdare">
        <table width="100%" cellspacing="0" class="dataTable">
            ...
            <tr class="tatr1">
                ...
                <td width="9%">IM_server负载ID</td>
                <td width="6%">物理主机ID</td>
                <td width="6%">主机wan_IP</td>
<!--                <td width="6%">主机local_IP</td>-->
                <td width="6%">开服时间</td>
                <td width="10%">im_server_ip</td>
                <td width="10%">im_server_port</td>
                <td width="10%">im_loginbalancer_ip</td>
                <td width="11%">im_loginbalancer_port</td>
...
<!--                        <td>--><?php //echo str_cut($val['content'], 58 ); ?><!--</td>-->
                        <td><?php echo $val['im_server_host_id']; ?></td>
                        <td><?php echo $val['server_id']; ?></td>
                        <td><?php echo $val['out_ip']; ?></td>
<!--                        <td>--><?php //echo $val['in_ip']; ?><!--</td>-->
                        <td><?php echo $val['open_server_time']; ?></td>
                        <td><?php echo $val['server_im_server_ip'] ;?></td>
                        <td><?php echo $val['server_im_server_port'] ;?></td>
                        <td><?php echo $val['server_im_loginbalancer_ip'] ;?></td>
                        <td><?php echo $val['server_im_loginbalancer_port'] ;?></td>
                        <td><?php echo $val['zk_path'] ;?></td>
                        <td><?php echo $val['status'] ;?></td>
                        <td >
                            <!--            <a href="javascript:;" onclick="toggle_state('--><?php //echo $val['id'];?><!--',this)"><?php echo $lang['hide']?></a>-->
                            <a href="index.php?app=game&act=editImServerSet&id=<?php echo $val['id'] ?>">编辑</a>
                            &nbsp;|&nbsp;
